...
const Saving = () => {
  ...
  return (
    <div className=" w-screen h-screen bg-cust-4 grid grid-cols-12 py-3">
      <div className="relative container lg:col-start-3 sm:col-start-2 col-start-1 lg:col-end-11 sm:col-end-12 col-end-13">
        <div>
          <div>
            <h1 className="font-semibold text-left text-5xl">Saving</h1>
          </div>
          <div className="mt-4">
