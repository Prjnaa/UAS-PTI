    ...
    <main className='w-screen min-h-screen flex flex-col bg-gradient-to-tr from-blue-800 to-blue-500 max-w-[500px] mx-auto p-10'>
      <form className='w-full bg-white flex flex-col gap-4 shadow-lg rounded-lg mt-8 p-6' autoComplete='off' onSubmit={handleEmailPasswordLogin}>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <input type='email' id='email' name='email' className='h-10 px-3 rounded-md border-[1px] border-gray-300' />

          <label htmlFor='password'>Password</label>
          <input type='password' id='password' name='password' className='h-10 px-3 rounded-md border-[1px] border-gray-300' />

          <div className='mt-4 flex flex-col gap-2'>
            <button type='submit' className='h-10 w-full bg-blue-500 text-white rounded-lg flex justify-center items-center'>
              Login
            </button>
            <button
