  ...
  return (
    <div className="w-[80%] h-[80%] p-4 flex flex-col bg-cust-3 border border-gray-200 rounded-lg shadow mb-5 ">
      ...
      <form className="flex flex-row space-x-4" onSubmit={handleNewMessage}>
        ...
        />
        <button
          className="bg-cust-4 w-32 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline hover:translate-y-[-5px] transition duration-300 ease-in-out"
          type="submit"
        >
          Send
        </button>
